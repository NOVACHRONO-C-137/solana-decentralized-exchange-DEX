...
export default function DotBackground() {
    ...
    useEffect(() => {
        ...
        function resize() { canvas.width = window.innerWidth; canvas.height = window.innerHeight; initDots(); }
        ...
        function draw(time: number) {
            ...
            for (const d of dots) {
                ...
                if (dist < MOUSE_RADIUS) { ctx.shadowColor = 'rgba(20,241,149,0.8)'; ctx.shadowBlur = 6 + (1 - dist / MOUSE_RADIUS) * 10; }
