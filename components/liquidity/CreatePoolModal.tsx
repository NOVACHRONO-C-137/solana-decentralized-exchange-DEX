            ...
            <DialogContent className="bg-[rgba(220,240,232,0.72)] dark:bg-[rgba(255,255,255,0.02)] backdrop-blur-[6px] border border-black/[0.06] dark:border-[rgba(255,255,255,0.06)] shadow-[0_2px_16px_0_rgba(0,0,0,0.06)] text-foreground w-[95vw] sm:max-w-[420px] p-4 sm:p-6 rounded-2xl">
                ...
                <div className="flex flex-col gap-3 mt-4">
                    ...
                    <div
                        ...
                        className={`rounded-xl p-3 sm:p-4 cursor-pointer transition-all ${mainOption === "pool"
                            ? "border border-[var(--neon-teal)] bg-[var(--neon-teal)]/5 dark:bg-[var(--neon-teal)]/10"
                            : "border border-black/[0.08] dark:border-white/[0.08] bg-white/50 dark:bg-black/20 hover:border-[var(--neon-teal)]/40"
                            }`}
                    >
                            ...
                            <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                                ...
                                <div className="flex flex-col gap-2.5">
                                    ...
                                    <div
                                        ...
                                        className={`p-2.5 sm:p-3.5 rounded-lg border cursor-pointer relative transition-all ${poolType === "concentrated" ? "border-[var(--neon-teal)] bg-white/5" : "border-border bg-background/60 dark:bg-secondary/30 dark:bg-black/20 hover:border-[#0D9B5F]/40 dark:hover:border-[#0D9B5F]/40 dark:hover:border-white/30"
                                            }`}
                                    >
                                        ...
                                        <div className="flex gap-3 items-start">
                                            ...
                                            <div className="flex flex-col gap-0.5">
                                                ...
                                                <p className={`text-[10px] sm:text-xs ${poolType === "concentrated" ? "text-[var(--neon-teal)]/70" : "text-muted-foreground"}`}>
                                    ...
                                    <div
                                        ...
                                        className={`p-2.5 sm:p-3.5 rounded-lg border cursor-pointer transition-all ${poolType === "standard" ? "border-indigo-400 bg-white/5" : "border-border bg-background/60 dark:bg-secondary/30 dark:bg-black/20 hover:border-[#0D9B5F]/40 dark:hover:border-[#0D9B5F]/40 dark:hover:border-white/30"
                                            }`}
                                    >
                                        <div className="flex gap-3 items-start">
                                            ...
                                            <div className="flex flex-col gap-0.5">
                                                ...
                                                <p className={`text-[10px] sm:text-xs ${poolType === "standard" ? "text-indigo-400/70" : "text-muted-foreground"}`}>
                                    ...
                                    <div
                                        ...
                                        className={`p-2.5 sm:p-3.5 rounded-lg border cursor-pointer transition-all ${poolType === "legacy" ? "border-[#0D9B5F] bg-[#0D9B5F]/5 dark:border-white/60 dark:bg-white/5" : "border-border bg-background/60 dark:bg-secondary/30 dark:bg-black/20 hover:border-[#0D9B5F]/40 dark:hover:border-[#0D9B5F]/40 dark:hover:border-white/30"
                                            }`}
                                    >
                                        <div className="flex gap-3 items-start">
                                            ...
                                            <div className="flex flex-col gap-0.5">
                                                ...
                                                <p className={`text-[10px] sm:text-xs ${poolType === "legacy" ? "text-muted-foreground" : "text-muted-foreground"}`}>
                    ...
                    <div
                        ...
                        className={`rounded-xl p-3 sm:p-4 cursor-pointer transition-all ${mainOption === "farm"
                            ? "border border-[var(--neon-teal)] bg-[var(--neon-teal)]/5 dark:bg-[var(--neon-teal)]/10"
                            : "border border-black/[0.08] dark:border-white/[0.08] bg-white/50 dark:bg-black/20 hover:border-[var(--neon-teal)]/40"}`}
                    >
                        <div className="flex justify-between items-center mb-2">
